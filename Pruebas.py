...
def paginalogin():
    ...
    botonregistrar=Button(ventana, text = "Si no tienes cuenta, dale click aquí", font = ("Times New Roman", 11, BOLD), bg = "#00A75E", fg = "white", bd = 0, command=pruebas2.paginaregister).place(x = 567, y = 355)
